...
import psycopg2
DB = dict(host=os.environ.get('DB_HOST','127.0.0.1'), port=int(os.environ.get('DB_PORT','5432')), dbname=os.environ.get('DB_NAME','pbxng'), user=os.environ.get('DB_USER','pbxng'), password=os.environ.get('DB_PASS',''), client_encoding='UTF8')
