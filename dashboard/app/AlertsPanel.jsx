...
const META = {
  ...
  'digest.daily':        { icon: <IconMail size={17} />,       color: 'teal',   title: 'Resumen diario', desc: 'Llamadas de ayer, perdidas, top extensiones, bloqueos y buzones.' },
};
const PARAMS = {
  ...
  'extension.offline': [['exts', 'Extensiones (csv)'], ['minutes', 'Tras N min']],
