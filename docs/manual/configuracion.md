...
## 3. SBC-NG · el borde de la central
...
### 3.1 ¿Qué es el SBC y por qué existe?
...
### 3.12 Sistema → Módulos y Configuración
...
## 6. Rutas salientes · qué se marca y por dónde sale
...
## 7. Rutas entrantes · qué pasa cuando te llaman
...
## 10. Entrega del teléfono: QR y enlace de acceso
